            ...
            <Card sx={{
                ...
                <Grid container spacing={2}>
                    <Grid item xs={12} sx={{ marginBottom: 5 }}>
                        <Typography variant='h4' align='center'>Case</Typography>
                        <Typography variant='body1' align='center' sx={{ border: 2, paddingY: 1, paddingX: 2, margin: 2, borderRadius: 2 }}>Case details</Typography>
                    </Grid>
                    <Grid item xs={12}>
                        <Grid container spacing={2}>
